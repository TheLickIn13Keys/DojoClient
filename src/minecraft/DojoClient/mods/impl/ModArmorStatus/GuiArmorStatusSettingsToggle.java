...
import DojoClient.mods.impl.ModFPS.ScrollListFPSToggle;
import net.minecraft.client.gui.GuiScreen;

import java.io.IOException;

public class GuiArmorStatusSettingsToggle extends GuiScreen {

    private ScrollListArmorStatusToggle scrollPanel;

    @Override
    public void initGui() {
        scrollPanel = new ScrollListArmorStatusToggle(mc, this);
