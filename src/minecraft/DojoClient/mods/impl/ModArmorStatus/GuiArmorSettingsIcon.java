...
public class GuiArmorSettingsIcon extends GuiButton {
    ...
    public GuiArmorSettingsIcon(int buttonId, int x, int y) {
        this(buttonId, x, y, 20, 20);
    }

    public GuiArmorSettingsIcon(int buttonId, int x, int y, int width, int height) {
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY) {
        if (this.visible) {
            ...
            System.out.println("Drew Armor Settings Icon");
        }
    }

    @Override
    public void mouseReleased(int mouseX, int mouseY) {
            Minecraft.getMinecraft().displayGuiScreen(new GuiArmorStatusSettingsToggle());
            System.out.println("Clicked Armor Settings Icon");
