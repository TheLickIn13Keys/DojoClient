...
import DojoClient.http.HWID;
import DojoClient.util.AnimatedResourceLocation;
...
public class GuiHWIDBanned extends GuiScreen {
    ...
    {
        gif = new AnimatedResourceLocation("DojoClient/ban", 44, 1);

        message = new IChatComponent[] {
                new ChatComponentText(EnumChatFormatting.GOLD + "" + EnumChatFormatting.BOLD + "You have been HWID banned from DojoClient!"),
                new ChatComponentText(""),
                new ChatComponentText("You have been banned for: "),
                new ChatComponentText(""),
                new ChatComponentText(EnumChatFormatting.AQUA + reason),
                new ChatComponentText(""),
                new ChatComponentText("You can appeal your ban at " + EnumChatFormatting.YELLOW + "https://mcdojo.club/").setChatStyle(
                        new ChatStyle()
                                .setChatClickEvent(new ClickEvent(ClickEvent.Action.OPEN_URL, "https://mcdojo.club/"))
    ...
    public void initGui()
    {
        ...
        if(clip == null) {
            try {
                InputStream in = mc.mcDefaultResourcePack.getInputStream(new ResourceLocation("DojoClient/ban/music.wav"));
