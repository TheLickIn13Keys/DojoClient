...
public class GuiSettingsIcon extends GuiButton {
    ...
    public GuiSettingsIcon(int buttonId, int x, int y) {
        this(buttonId, x, y, 20, 20);
    }

    public GuiSettingsIcon(int buttonId, int x, int y, int width, int height) {
